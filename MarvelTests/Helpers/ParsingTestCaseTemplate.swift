...
protocol ParsingTestCaseTemplate: ParsingTester {
    ...
    /// Builds the object that will be used as the expectation for a parsing test. Classes conforming to ``ParsingTestCaseTemplate`` need to implement this to return the specific associated parseable object.
