...
protocol ParsingTestCaseTemplate: ParsingTester {
    ...
    func runParsingTest(filePath: StaticString, line: UInt) throws
...
extension ParsingTestCaseTemplate where Self: XCTestCase {
    func runParsingTest(filePath: StaticString = #filePath, line: UInt = #line) throws {
        let actual = try givenParsedObjectFromJson()
